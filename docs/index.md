...
<p align="center">
  ...
  <a href="https://github.com/architect-xyz/composer/blob/main/LICENSE"><img src="https://img.shields.io/github/license/architect-xyz/composer" alt="License: MIT"></a>
...
See [docker.md](docker.md) for the container-based setup.
...
See [aliases.md](aliases.md) for full details.
...
- [aliases.md](aliases.md) — Shell alias reference
- [docker.md](docker.md) — Container-based setup (legacy)
